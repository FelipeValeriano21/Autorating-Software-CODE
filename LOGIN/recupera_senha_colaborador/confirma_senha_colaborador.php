    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-9 col-lg-12 col-xl-10">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="update_senha_colaborador.php" id="myForm">
                                        <div class="mb-3">
                                            <input type="text" id="novasenha" aria-describedby="emailHelp" placeholder="Nova Senha" name="novasenha" class="form-control" maxlength="25"> 
                                        </div>
                                        <div class="mb-3">
                                            <input class="form-control" type="text" id="confirmanovaSenha" placeholder="Confirmar Nova Senha" name="confirmanovasenha" maxlength="25">
                                        </div>
                ...
                if (isset($_SESSION['confirmarsenhaerrocolab'])) {
                ?>
                ...
                <?php
                    echo $_SESSION['confirmarsenhaerrocolab'];
                    unset($_SESSION['confirmarsenhaerrocolab']);
                }
                ?>

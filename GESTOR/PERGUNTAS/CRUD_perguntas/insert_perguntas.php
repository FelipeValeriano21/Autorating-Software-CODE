            ...
            <form id="insertPeguntas" action="insert.php" method="post"><input class="form-control" type="hidden" name="Introduction" value="This email was sent from www.awebsite.com"><input class="form-control" type="hidden" name="subject" value="Awebsite.com Contact Form"><input class="form-control" type="hidden" name="to" value="email@awebsite.com">
                ...
                <div class="row">
                    <div class="col-12 col-md-6" id="message-1">
                            ...
                            <div class="form-group mb-3"><label class="form-label" for="from-calltime" >Categoria da Questão</label>
                                <div class="input-group"><select class="form-select" id="from-calltime-4" name="categoria">
                                             ...
                                             <?php 
                                                ...
                                                ?>
                                            <option value="<?php echo $idTB_Categoria  ?>" name = "categoria"  selected="" id="categoria"><?php echo $Categoria_Nome ?></option>
                            ...
                            <div class="form-group mb-3"><label class="form-label" for="from-calltime">Categoria da Questão</label>
                                <div class="input-group"><select class="form-select" id="from-calltime-4" name="tipoquestao">
                                             ...
                                             <?php 
                                                ...
                                                ?>
                                            <option value="<?php echo  $idTB_Tipo_Questao  ?>" selected="" name="tipoquestao"  id="tipoquestao"><?php echo  $Tipo_Nome  ?></option>
                        ...
                        <div class="form-group mb-3"><label class="form-label" for="from-comments">Comando da Questão</label><textarea class="form-control" id = "comando"  name="comando" placeholder="Comando da Questão" rows="5" maxlength="255"></textarea></div>
                        <div class="form-group mb-3">
                            <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                       ...
                       <input class="form-control" id="respA" name="respA"  placeholder="Resposta A" maxlength="255">
                     </div>
                        <div class="form-group mb-3"><label class="form-label" for="from-calltime">Resposta B:</label>
                       <input class="form-control" id="respB" name="respB" placeholder="Resposta B" maxlength="255">
                        </div>
                        <div class="form-group mb-3"><label class="form-label" for="from-calltime">Resposta C:</label>
                       <input class="form-control" id="respC"  name="respC"  placeholder="Resposta C" maxlength="255">
                        </div>
                        <div class="form-group mb-3"><label class="form-label" for="from-calltime">Resposta D:</label>
                       <input class="form-control" id="respD" name="respD" id="respD"  placeholder="Resposta D" maxlength="255">
                        </div>
